...
generate = st.button("Generate Schedule", key="generate_schedule")
...
if generate and employees and givers:
    try:
        ...
        for giver in givers:
            ...
            final_tables[giver] = edited_df

        final_df = pd.concat(final_tables.values(), ignore_index=True)
        ...
        with pd.ExcelWriter(buffer, engine="openpyxl") as writer:
            for giver, g_df in final_tables.items():
