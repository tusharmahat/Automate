...
if generate:
    ...
    # Global queues for A and B shift employees
    ...
    for giver in givers:
        ...
        # Determine number of breaks for A and B
        ...
        # Remove assigned employees from queues
        ...
        # --- Wait until B-shift +1 hour after B shift start ---
        if assigned_B:
